FIRST read .factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/016-discovery-detail-product/handoff.json, then its sourceContext index.
...
Task: {"id":"detail-product","scope":"group","buildGroup":"product"}.


DETAILED SNAPSHOT FOR ASSIGNED BUILD GROUP ONLY: product.
...
Run node scripts/factory/autopilot/gates.js group product; fix all group-specific failures before returning.
