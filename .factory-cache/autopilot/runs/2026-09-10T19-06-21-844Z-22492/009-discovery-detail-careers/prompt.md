...
Task: {"id":"detail-careers","scope":"group","buildGroup":"careers","routes":[{"id":"careers","path":"/kariera/","language":"pl","frameNodeId":"349:1267","reference":"references/full/frame-349-1267.png","width":1920,"height":3802,"sections":["shared-topbar","shared-secondary-navigation","shared-primary-navigation","careers-heading","careers-vacancies","careers-application","shared-shop-cta","shared-footer"],"buildGroup":"careers","responsiveSource":"derived","notes":"Source frame titled kariera contains an expanded job offer, five collapsed offers and an application form. Planned local route path is an implementation decision inferred from source page identity, not a captured source hyperlink. Uncaptured section IDs remain explicit in this partial execution plan.","sectionGeometry":{"shared-primary-navigation":{"x":240,"y":115,"width":1440,"height":78.6761245727539}}}]}.


DETAILED SNAPSHOT FOR ASSIGNED BUILD GROUP ONLY: careers.
...
Run node scripts/factory/autopilot/gates.js group careers; fix all group-specific failures before returning.
...
Read this compact handoff FIRST: .factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/009-discovery-detail-careers/handoff.json.
