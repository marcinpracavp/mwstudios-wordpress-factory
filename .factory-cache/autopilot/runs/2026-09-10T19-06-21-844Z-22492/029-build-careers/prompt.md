FIRST read .factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/029-build-careers/handoff.json, then its sourceContext index.
...
{"status":"needs_work","summary":"Careers visual refinements compiled successfully and responsive health is clean, but the scoped pixel gate still fails at 5.063% (threshold 1%).","evidence":["partials/footer.php","src/css/layouts/_footer.scss","src/css/pages/_careers.scss","docs/factory/project/STATUS.md",".factory-cache/autopilot/visual-1789155701699/careers/comparison.json"],"issues":["Desktop visual pixel mismatch remains 5.063%; section pixel gate fails.","CF7 recipient, upload-retention policy, and privacy-policy destination are not source-provided."]}
