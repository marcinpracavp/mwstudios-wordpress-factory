...
Task: {"id":"detail-catalogues","scope":"group","buildGroup":"catalogues","routes":[{"id":"catalogues","path":"/katalogi/","language":"pl","frameNodeId":"347:1120","reference":"references/full/frame-347-1120.png","width":1920,"height":1850,"sections":["shared-topbar","shared-secondary-navigation","shared-primary-navigation","catalogues-heading","catalogues-downloads","shared-shop-cta","shared-footer"],"buildGroup":"catalogues","responsiveSource":"derived","notes":"Source frame titled katalogi contains two catalogue cards, PDF and online-reader actions. Planned local route path is an implementation decision inferred from source page identity, not a captured source hyperlink. Uncaptured section IDs remain explicit in this partial execution plan."}]}.


DETAILED SNAPSHOT FOR ASSIGNED BUILD GROUP ONLY: catalogues.
...
Run node scripts/factory/autopilot/gates.js group catalogues; fix all group-specific failures before returning.
...
Read this compact handoff FIRST: .factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/010-discovery-detail-catalogues/handoff.json.
