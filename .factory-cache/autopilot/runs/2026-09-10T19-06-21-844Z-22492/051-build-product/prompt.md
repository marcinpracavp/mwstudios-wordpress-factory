FIRST read .factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/051-build-product/handoff.json, then its sourceContext index.
...
{"status":"needs_work","summary":"Zweryfikowano oba przypisane warianty i zbudowano motyw bez błędów kompilacji. Nie wprowadzono fikcyjnej opinii WooCommerce ani dalszych zmian odroczonej geometrii opisu.","evidence":[".factory-cache/autopilot/visual-1789228631768/product-expanded/comparison.json",".factory-cache/autopilot/visual-1789228658033/product-reviews-state/comparison.json",".factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/050-build-product/product-reviews-state.source-dependency.json",".factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/050-build-product/product-reviews-state.runtime-probe.json","docs/factory/project/STATUS.md"],"issues":["product-expanded: 8.751% page mismatch; expanded description remains 331px too short and is deferred to final audit under churn policy.","product-reviews-state: Aquatos 5L has no native WooCommerce comments; an approved real review with rating, author/date and body is required.","Shared product-gallery mismatch remains for the final shared-component audit."]}
