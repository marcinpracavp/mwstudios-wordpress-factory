FIRST read .factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/067-build-product-archive/handoff.json, then its sourceContext index.
...
Task: {"id":"product-archive"}.
Previous attempt/gate feedback (act only on these concrete failures):
{"status":"needs_work","summary":"Built the native WooCommerce Fungicydy archive, imported 18 source-backed cards and pagination SVG, and verified native category/variation/review data. Build succeeds; visual acceptance does not pass.","evidence":["taxonomy-product_cat.php","acf-json/group_rudnikagro_product_archive.json","scripts/factory/project/import-content.php","scripts/factory/project/commerce-probe.php",".factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/066-build-product-archive/commerce-probe.json",".factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/066-build-product-archive/import-repeat-verified.json",".factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/066-build-product-archive/build.log",".factory-cache/autopilot/visual-1789294203652/product-archive/comparison.json","docs/factory/project/SOURCE_CLARIFICATIONS.md","docs/factory/project/STATUS.md"],"issues":["Page-only visual QA remains 31.636% mismatch; this exceeds acceptance and is not eligible for visual deferral.","archive-filters geometry remains 104.03px shorter than the source.","Frozen source context lacks exact text records for WYSIWYG nodes 295:741 and 303:1276; their editable fields remain empty rather than receiving invented copy."]}
