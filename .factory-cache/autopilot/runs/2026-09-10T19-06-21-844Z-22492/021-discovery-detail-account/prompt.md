FIRST read .factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/021-discovery-detail-account/handoff.json, then its sourceContext index.
...
Task: {"id":"detail-account","scope":"group","buildGroup":"account"}.


DETAILED SNAPSHOT FOR ASSIGNED BUILD GROUP ONLY: account.
...
Run node scripts/factory/autopilot/gates.js group account; fix all group-specific failures before returning.
