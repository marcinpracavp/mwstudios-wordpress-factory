FIRST read .factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/017-discovery-detail-cart/handoff.json, then its sourceContext index.
...
Task: {"id":"detail-cart","scope":"group","buildGroup":"cart"}.


DETAILED SNAPSHOT FOR ASSIGNED BUILD GROUP ONLY: cart.
...
Run node scripts/factory/autopilot/gates.js group cart; fix all group-specific failures before returning.
