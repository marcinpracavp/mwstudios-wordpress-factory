FIRST read .factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/050-build-product/handoff.json, then its sourceContext index.
...
{"status":"needs_work","summary":"Panel plików został skorygowany i odroczony do finalnego audytu przy 8.527%. Rozwinięty opis pozostaje na 8.751% po wycofaniu regresji. Opinie wymagają prawdziwych danych WooCommerce; nie utworzono fikcyjnej recenzji.","evidence":["single-product.php","src/css/pages/_product.scss","src/js/product.js","docs/factory/project/STATUS.md",".factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/049-build-product/product-reviews-state.source-dependency.json",".factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/049-build-product/product-reviews-state.runtime-probe.json",".factory-cache/autopilot/visual-1789228249992/product-files-state/comparison.json",".factory-cache/autopilot/visual-1789228348813/product-expanded/comparison.json",".factory-cache/autopilot/visual-1789228326058/product-reviews-state/comparison.json"],"issues":["product-expanded: 8.751% page mismatch; geometry opisu i dalszego przepływu pozostaje odroczona z powodu churn policy.","product-reviews-state: brak rzeczywistych komentarzy WooCommerce dla Aquatos 5L; wymagany zatwierdzony rekord opinii.","Shared product-gallery mismatch pozostaje do finalnego audytu komponentów współdzielonych."]}
...
If matching a captured state requires missing genuine business data (e.g. real customer reviews or an approved existing order),
