FIRST read .factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/020-discovery-detail-product-archive/handoff.json, then its sourceContext index.
...
Task: {"id":"detail-product-archive","scope":"group","buildGroup":"product-archive"}.


DETAILED SNAPSHOT FOR ASSIGNED BUILD GROUP ONLY: product-archive.
...
Run node scripts/factory/autopilot/gates.js group product-archive; fix all group-specific failures before returning.
