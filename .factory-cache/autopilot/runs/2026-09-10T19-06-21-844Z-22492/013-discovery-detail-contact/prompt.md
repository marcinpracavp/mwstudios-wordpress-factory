FIRST read .factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/013-discovery-detail-contact/handoff.json, then its sourceContext index.
...
Task: {"id":"detail-contact","scope":"group","buildGroup":"contact"}.


DETAILED SNAPSHOT FOR ASSIGNED BUILD GROUP ONLY: contact.
...
Run node scripts/factory/autopilot/gates.js group contact; fix all group-specific failures before returning.
