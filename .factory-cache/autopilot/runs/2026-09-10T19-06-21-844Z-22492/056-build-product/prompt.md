FIRST read .factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/056-build-product/handoff.json, then its sourceContext index.
...
{"status":"needs_work","summary":"Product geometry is healthy for both assigned states, but neither meets page acceptance and visual deferral is not authorized. Further template edits are currently blocked by the environment usage limit.","evidence":[".factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/055-build-product/handoff.json",".factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/055-build-product/source-context/index.json",".factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/resume-page-check-1789245662957/product-expanded/product-expanded/comparison.json",".factory-cache/autopilot/runs/2026-09-10T19-06-21-844Z-22492/resume-page-check-1789245662957/product-files-state/product-files-state/comparison.json","docs/factory/project/COMMERCE_PROBE.json","docs/factory/project/SOURCE_CLARIFICATIONS.md"],"issues":["product-expanded: page mismatch 8.826% exceeds 8.5%; product-tabs shared geometry/mismatch remains for final audit; progress.deferred is false.","product-files-state: page mismatch 8.664% exceeds 8.5%; progress.deferred is false.","Local HTML probe after the prior fix still lacked both native related-card titles, requiring a scoped template repair.","Exact download SVG export and separable related-card image assets remain unavailable; these are recorded in SOURCE_CLARIFICATIONS.md."]}
